...
df=pd.read_csv("H:\Major Project\Backend\k10-43-35-In-Report.csv")
df2=pd.read_csv("H:\Major Project\Backend\k12-21-05-Out-Report.csv")
path = 'H:\Major Project\Backend\Reports\SPOT'
